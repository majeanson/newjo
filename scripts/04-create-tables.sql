-- Create all required tables for the multiplayer card game
-- This replaces the Prisma db push command
...
CREATE INDEX idx_played_cards_user ON played_cards(user_id);
